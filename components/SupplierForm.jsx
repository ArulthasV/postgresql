...
function SupplierForm({ onSubmitted, handleShow }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="bg-white rounded grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="mb-4">
          <label
      ...
      <div className="flex items-center justify-between mb-4">
          <button
            className="w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mx-1"
            type="submit"
          >
            Submit
          </button>
